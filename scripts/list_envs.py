...
All the environments are registered in the `Kuka_Med_7` extension. They start
...
import Kuka_Med_7.tasks  # noqa: F401


def main():
    """Print all environments registered in `Kuka_Med_7` extension."""
